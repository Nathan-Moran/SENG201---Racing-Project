...
import javafx.util.Duration; // Import Duration, as it's used in setOnEndOfMedia
...
public class MusicController {
    ...
    public void initializeMusic(String fileName) {
        try {
            ...
            musicPlayer.setVolume(0.05); // Set volume to 5%
            musicPlayer.setOnEndOfMedia(() -> musicPlayer.seek(Duration.ZERO)); // Loop music
