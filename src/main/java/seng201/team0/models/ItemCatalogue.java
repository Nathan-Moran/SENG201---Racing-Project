...
public class ItemCatalogue extends ItemStorage{
    ...
    public void setupCatalogue() {
        ...
        addLockedCar(new Car("Dune Drifter", 0.5, 0.8, 0.7, 22.0, 2200));         //Desert Drift
        addLockedCar(new Car("Sandstorm Strider", 0.8, 0.5, 0.8, 25.0, 2800));    //Desert Long
        addLockedCar(new Car("Cliff Climber", 0.6, 0.5, 0.9, 20.0, 2600));        //Mountain Steep
        addLockedCar(new Car("Ridge Racer", 0.5, 0.9, 0.7, 28.0, 3000));          //Mountain Curves
        addLockedCar(new Car("Farmers Flyer", 0.9, 0.4, 0.9, 30.0, 3800));        //Country Straight
        addLockedCar(new Car("Vineyard Viper", 0.6, 0.8, 0.8, 24.0, 3000));       //Country Twist
        addLockedCar(new Car("Alley Cat", 0.8, 0.5, 0.7, 23.0, 2600));            //City Alleys
        addLockedCar(new Car("Commuter King", 0.4, 0.7, 0.9, 28.0, 3300));        //City Traffic
    }
