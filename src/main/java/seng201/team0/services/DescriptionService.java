...
public class DescriptionService {
    ...
    static {
        ...
        carDescriptions.put("Ferrari 458", "An exotic masterpiece delivering blistering top speed and almost telepathic handling. The Ferrari 458 is a top-tier performer, capable of dominating almost any route if driven skillfully. High reliability ensures it can take the heat, but its racing pedigree means it consumes fuel quickly. A dream machine for ambitious racers.");
        carDescriptions.put("Dune Drifter", "Unlocked by conquering Desert Drift, the Dune Drifter is a true handling specialist. Its modest top speed is more than offset by its incredible agility on loose surfaces, making it dance where others struggle. Good reliability and fuel economy make it a smart choice for technical desert stages.");
        carDescriptions.put("Sandstorm Strider", "Your reward for mastering Desert Long. The Sandstorm Strider is built for sustained high-speed desert runs, boasting impressive pace and excellent dependability. Its handling is stable and predictable, and its fantastic fuel efficiency is perfect for those long hauls.");
        carDescriptions.put("Cliff Climber", "Earned by taming Mountain Steep, the Cliff Climber's defining trait is its exceptional resilience. It’s not the fastest or nimblest, but its ability to keep going under duress will get you to the top when others falter. It also offers decent fuel economy for such a rugged machine.");
        ...
        carDescriptions.put("Farmers Flyer", "Awarded for dominating Country Straight, the Farmers Flyer is a wolf in sheep's clothing with surprisingly potent acceleration. Its less refined handling demands respect on anything but a straight line. However, its fantastic reliability and exceptional fuel efficiency make it a unique speedster.");
        ...
        carDescriptions.put("Alley Cat", "Your prize for conquering City Alleys. The Alley Cat is quick on its feet, offering good acceleration for urban sprints. Its handling is serviceable for nipping through gaps, and it provides decent reliability and fuel economy for city missions.");
        carDescriptions.put("Commuter King", "Master the chaos of City Traffic to unlock the Commuter King. Its standout feature is its rock-solid dependability, ensuring it won't let you down. While not built for outright speed, its decent handling helps navigate jams, and its excellent fuel efficiency makes it a surprisingly effective urban tool.");
